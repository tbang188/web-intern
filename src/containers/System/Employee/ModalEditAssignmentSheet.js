...
class ModalEditAssignmentSheet extends Component {
    constructor(props) {
        super(props);
        this.state = {
            id: "",
                ...
                <ModalBody>
                    ...
                    <div className="modal-user-body">
                        <div className="input-container">
                            ...
                            <DatePicker
                                placeholder="dd/mm/yyyy"
                                onChange={this.handleonChangeDatePickerWeek1}
                                value={this.state.ngaybd1}
                            />
                        </div>
                        <div className="input-container">
                            <label>
                            ...
                            <input
                                type="tex"
                                placeholder="Nhập vào số buổi làm việc"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "sobuoi1");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "vieclam1");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "ghichu1");
                                }}
                    ...
                    <div className="modal-user-body">
                        <div className="input-container">
                            ...
                            <DatePicker
                                placeholder="dd/mm/yyyy"
                                onChange={this.handleonChangeDatePickerWeek2}
                                value={this.state.ngaybd2}
                            />
                        </div>
                        <div className="input-container">
                            <label>
                            ...
                            <input
                                ...
                                placeholder="Nhập vào số buổi làm việc"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "sobuoi2");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                placeholder="Nhập vào nội dung công việc"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "vieclam2");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                placeholder="Nhập vào ghi chú"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "ghichu2");
                                }}
                    ...
                    <div className="modal-user-body">
                        <div className="input-container">
                            ...
                            <DatePicker
                                placeholder="dd/mm/yyyy"
                                onChange={this.handleonChangeDatePickerWeek3}
                                value={this.state.ngaybd3}
                            />
                        </div>
                        <div className="input-container">
                            <label>
                            ...
                            <input
                                ...
                                placeholder="Nhập vào số buổi làm việc"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "sobuoi3");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                placeholder="Nhập vào nội dung công việc"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "vieclam3");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                placeholder="Nhập vào ghi chú"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "ghichu3");
                                }}
                    ...
                    <div className="modal-user-body">
                        <div className="input-container">
                            ...
                            <DatePicker
                                placeholder="dd/mm/yyyy"
                                onChange={this.handleonChangeDatePickerWeek4}
                                value={this.state.ngaybd4}
                            />
                        </div>
                        <div className="input-container">
                            <label>
                            ...
                            <input
                                ...
                                placeholder="Nhập vào số buổi làm việc"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "sobuoi4");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                placeholder="Nhập vào nội dung công việc"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "vieclam4");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                placeholder="Nhập vào ghi chú"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "ghichu4");
                                }}
                    ...
                    <div className="modal-user-body">
                        <div className="input-container">
                            ...
                            <DatePicker
                                placeholder="dd/mm/yyyy"
                                onChange={this.handleonChangeDatePickerWeek5}
                                value={this.state.ngaybd5}
                            />
                        </div>
                        <div className="input-container">
                            <label>
                            ...
                            <input
                                ...
                                placeholder="Nhập vào số buổi làm việc"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "sobuoi5");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                placeholder="Nhập vào nội dung công việc"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "vieclam5");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                placeholder="Nhập vào ghi chú"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "ghichu5");
                                }}
                    ...
                    <div className="modal-user-body">
                        <div className="input-container">
                            ...
                            <DatePicker
                                placeholder="dd/mm/yyyy"
                                onChange={this.handleonChangeDatePickerWeek6}
                                value={this.state.ngaybd6}
                            />
                        </div>
                        <div className="input-container">
                            <label>
                            ...
                            <input
                                ...
                                placeholder="Nhập vào số buổi làm việc"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "sobuoi6");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                placeholder="Nhập vào nội dung công việc"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "vieclam6");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                placeholder="Nhập vào ghi chú"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "ghichu6");
                                }}
                    ...
                    <div className="modal-user-body">
                        <div className="input-container">
                            ...
                            <DatePicker
                                placeholder="dd/mm/yyyy"
                                onChange={this.handleonChangeDatePickerWeek7}
                                value={this.state.ngaybd7}
                            />
                        </div>
                        <div className="input-container">
                            <label>
                            ...
                            <input
                                ...
                                placeholder="Nhập vào số buổi làm việc"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "sobuoi7");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                placeholder="Nhập vào nội dung công việc"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "vieclam7");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                placeholder="Nhập vào ghi chú"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "ghichu7");
                                }}
                    ...
                    <div className="modal-user-body">
                        <div className="input-container">
                            ...
                            <DatePicker
                                placeholder="dd/mm/yyyy"
                                onChange={this.handleonChangeDatePickerWeek8}
                                value={this.state.ngaybd8}
                            />
                        </div>
                        <div className="input-container">
                            <label>
                            ...
                            <input
                                ...
                                placeholder="Nhập vào số buổi làm việc"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "sobuoi8");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                placeholder="Nhập vào nội dung công việc"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "vieclam8");
                                }}
                    ...
                    <div className="sigal-input">
                        <div className="input-container">
                            ...
                            <input
                                ...
                                placeholder="Nhập vào ghi chú"
                                onChange={(event) => {
                                    this.handleonChangeInput(event, "ghichu8");
                                }}
